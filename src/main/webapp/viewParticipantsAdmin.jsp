...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .delegate-cell .delegate-badge {
            display: inline-flex;
            align-items: center;
            gap: 5px;
            background: rgba(44,83,100,0.08);
            border: 1px solid rgba(44,83,100,0.12);
            border-radius: 8px;
            padding: 3px 10px;
            font-size: 0.78rem;
            color: var(--teal);
...
<nav class="navbar navbar-dark">
    <div class="container-fluid px-3">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <span class="navbar-sub">ADMIN</span>
        </div>
...
<div class="page-header">
    ...
    <div class="container" data-aos="fade-up">
        <div class="page-header-badge"><i class="fas fa-users me-1"></i> Conference Management</div>
        <h3>Conference <span>Participants</span></h3>
        <p class="sub">View all participants invited for this conference and their response status.</p>
    </div>
</div>
...
<div class="stats-strip">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-4 col-md-3">
                <div class="strip-stat">
                    <div class="strip-stat-num" id="declinedCount">—</div>
                    <div class="strip-stat-label">Declined</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="table-wrapper">
                <table class="table table-hover" id="participantsTable">
                    ...
                    <tr>
                        ...
                        <th><i class="fas fa-user-tie me-1" style="opacity:0.7;"></i>Delegate Email</th>
                        ...
                        <tr>
                            ...
                            <td class="delegate-cell">
                                    <span class="delegate-badge">
                                        <i class="fas fa-user-tie"></i>${p.delegate.email}
                                    </span>
                            </td>

                            <td>
                                <c:choose>
                                    <c:when test="${fn:toLowerCase(p.attending) == 'yes'}">
                                            <span class="status-badge status-attending">
                                                <i class="fas fa-check-circle"></i> Attending
                                            </span>
                                    </c:when>
                                    <c:when test="${fn:toLowerCase(p.attending) == 'no'}">
